...
const UI = {
  vi: {
    ...
    openRef: "Mở giao dịch này trong bảng bằng chứng",
    ...
    history: "Lịch sử",
    historyEmpty: "Chưa có lịch sử trò chuyện",
    deleteHistory: "Xoá",
    deleteConfirm: "Xoá cuộc trò chuyện này?",
    today: "Hôm nay",
    yesterday: "Hôm qua",
    thisWeek: "Tuần này",
    earlier: "Trước đó",
  ...
  en: {
    ...
    openRef: "Open this transaction in the evidence panel",
