...
KIND_LABEL: dict[FindingKind, Label] = {
    ...
    FindingKind.SUSPECTED_DUPLICATE: Label.NEEDS_YOUR_CONFIRMATION,
    FindingKind.SPENDING_SPIKE: Label.NEEDS_YOUR_CONFIRMATION,
    FindingKind.CATEGORY_CONCENTRATION: Label.NEEDS_YOUR_CONFIRMATION,
    FindingKind.OFF_HOURS_TXN: Label.NEEDS_YOUR_CONFIRMATION,
    FindingKind.RAPID_SPENDING: Label.NEEDS_YOUR_CONFIRMATION,
    FindingKind.SUBSCRIPTION_NO_WELCOME: Label.INSUFFICIENT_DATA,
    FindingKind.CHARGED_AFTER_CANCEL: Label.NEEDS_YOUR_CONFIRMATION,
    FindingKind.FREE_TRIAL_CONVERTED: Label.RECURRING_CONFIRMED,
    FindingKind.LATE_REFUND: Label.INSUFFICIENT_DATA,
}
